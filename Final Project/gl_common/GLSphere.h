...
protected:
	...
	void initVBONormals1(void);
	void initVBONormals2(void);
	void initVBONormals3(void);
	void initVBONormals4(void);
    
    /*!
     Shader for the normal vector renderer
     */
    void initShaderNormal(void);
	void initShaderNormal1(void);
	void initShaderNormal2(void);
	void initShaderNormal3(void);
	void initShaderNormal4(void);
