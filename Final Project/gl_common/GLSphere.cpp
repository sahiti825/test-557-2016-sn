...
void GLSphere::initVBO(void)
{
    ...
    for(int i=0; i<_spherePoints.size() ; i++)
    {
        ...
        colors[(i*3)] =0.5; colors[(i*3)+1] = 0.1; colors[(i*3)+2] = 1.0;
    }
...
void GLSphere::initVBO1(void)
{
	...
	for (int i = 0; i<_spherePoints.size(); i++)
	{
		...
		colors[(i * 3)] = 0.5; colors[(i * 3) + 1] = 0.0; colors[(i * 3) + 2] = 0.0;
	}
...
void GLSphere::initVBONormals1(void)
{
...
void GLSphere::initVBONormals2(void)
{
...
void GLSphere::initVBONormals3(void)
{
...
void GLSphere::initVBONormals4(void)
{
...
void GLSphere::initShader(void)
{
    ...
    _material._specular_material = glm::vec3(2.0, 2.0, 2.0);
	_material._shininess = 500.0;
    ...
    _light_source0._lightPos = glm::vec4(200.0,250.0,250.0,1.0);
    _light_source0._ambient_intensity = 0.5;
	_light_source0._specular_intensity = 100;
	_light_source0._diffuse_intensity = 10000;
...
void GLSphere::initShader1(void)
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	// Material
	_material._diffuse_material = glm::vec3(0.5, 0.01, 0.01);
	_material._ambient_material = glm::vec3(0.5, 0.0, 0.0);
	_material._specular_material = glm::vec3(0.50, 0.05, 0.05);
	_material._shininess = 250.0;
	...
	// define the position of the light and send the light position to your shader program
	_light_source0._lightPos = glm::vec4(140.0, 5.0, 100.0, 1.0);
	_light_source0._ambient_intensity = 0.1;
	_light_source0._specular_intensity = 200;
	_light_source0._diffuse_intensity = 40;
...
void GLSphere::initShader2(void)
{
	...
	// define the position of the light and send the light position to your shader program
	_light_source0._lightPos = glm::vec4(50.0, 40.0, 250.0, 1.0);
	_light_source0._ambient_intensity = 0.5;
	_light_source0._specular_intensity = 10;
	_light_source0._diffuse_intensity = 100;
...
void GLSphere::initShader3(void)
{
	...
	_material._specular_material = glm::vec3(0.5, 0.5, 0.5);
	...
	// define the position of the light and send the light position to your shader program
	_light_source1._lightPos = glm::vec4(200.0,250.0, 250.0, 1.0);
	_light_source1._ambient_intensity = 0.0;
	_light_source1._specular_intensity = 10;
	_light_source1._diffuse_intensity = 10;
	

	_light_source1._cone_angle = 1.3; // in degree
	_light_source1._cone_direction = glm::vec3(-14.8, -36.5, -36.3); // this must be aligned with the object and light position.
	//_light_source1._cone_direction = glm::vec3(-50.0, -10.0, -100.0); // this must be aligned with the object and light position.
...
void GLSphere::initShader4(void)
{
...
#ifdef _WIN32
	// This loads the shader program from a file
	_program = LoadAndCreateShaderProgram("multilight.vs", "multilight.fs");
#else
	// This loads the shader program from a file
	_program = LoadAndCreateShaderProgram("../../data/shaders/2spotlights.vs", "../../data/shaders/2spotlights.fs");
#endif
	...
	_light_source0._lightPosIdx = glGetUniformLocation(_program, "light_position");
	_light_source1._lightPosIdx = glGetUniformLocation(_program, "light_position2");
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	// Material
	_material._diffuse_material = glm::vec3(0.5, 0.4, 0.1);
	_material._ambient_material = glm::vec3(0.5, 0.4, 0.1);
	_material._specular_material = glm::vec3(0.6, 0.7, 0.3);
	...
	// define the position of the light and send the light position to your shader program
	_light_source0._lightPos = glm::vec4(500.0, 250.0, 25.0, 1.0);
	_light_source0._ambient_intensity = 0.3;
	_light_source0._specular_intensity = 10;
	_light_source0._diffuse_intensity = 10;
	

	//_light_source0._cone_angle = 38.60; // in degree
	//_light_source0._cone_direction = glm::vec3(-50.0, -10.0, -100.0); // this must be aligned with the object and light position.
																	  //_light_source1._cone_direction = glm::vec3(-50.0, -10.0, -100.0); // this must be aligned with the object and light position.
	...
	//second light
	_light_source1._lightPos = glm::vec4(50.0, 50.0, 200.0, 1.0);
	_light_source1._ambient_intensity = 1.0;
	_light_source1._specular_intensity = 2.0;
	_light_source1._diffuse_intensity = 3.0;
	
	_light_source1._cone_angle = 140.0; // in degree
	_light_source1._cone_direction = glm::vec3(100.0, 500.0, 100.0); // this must be aligned with the object and light position.
																	  //_light_source1._cone_direction = glm::vec3(-50.0, -10.0, -100.0); // this must be aligned with the object and light position.


	_light_source1._ambientIdx = glGetUniformLocation(_program, "ambient_intensity2");
	_light_source1._diffuseIdx = glGetUniformLocation(_program, "diffuse_intensity2");
	_light_source1._specularIdx = glGetUniformLocation(_program, "specular_intensity2");
	_light_source1._cone_angleIdx = glGetUniformLocation(_program, "cone_angle2");
	_light_source1._cone_directionIdx = glGetUniformLocation(_program, "cone_direction2");
...
void GLSphere::initShader4(void)
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	// Material
	_material._diffuse_material = glm::vec3(0.941, 0.902, 0.549);
	_material._ambient_material = glm::vec3(0.941, 0.902, 0.549);
	_material._specular_material = glm::vec3(0.941, 0.902, 0.549);
	_material._shininess = 300.0;
	...
	_light_source1._lightPos = glm::vec4(200.0, 250.0, 250.0, 1.0);
	_light_source1._ambient_intensity = 0.0;
	_light_source1._specular_intensity = 100;
	_light_source1._diffuse_intensity = 1000;
	_light_source1._attenuation_coeff = 0.7;

	_light_source1._cone_angle = 38.60; // in degree
	_light_source1._cone_direction = glm::vec3(-50.0, -10.0, -100.0); // this must be aligned with the object and light position.
																	  //_light_source1._cone_direction = glm::vec3(-50.0, -10.0, -100.0); // this must be aligned with the object and light position.
...
void GLSphere::initShader4(void)
{
	...
	_light_source1._ambient_intensity = 0.0;
	_light_source1._specular_intensity = 100;
	_light_source1._diffuse_intensity = 10000;
...
void GLSphere::initShaderNormal1(void)
{
	_program_normals = CreateShaderProgram(vs_string_simple_shader_410, fs_string_simple_shader_410);
...
void GLSphere::initShaderNormal2(void)
{
	_program_normals = CreateShaderProgram(vs_string_simple_shader_410, fs_string_simple_shader_410);
...
void GLSphere::initShaderNormal3(void)
{
	_program_normals = CreateShaderProgram(vs_string_simple_shader_410, fs_string_simple_shader_410);
...
void GLSphere::initShaderNormal4(void)
{
	_program_normals = CreateShaderProgram(vs_string_simple_shader_410, fs_string_simple_shader_410);
