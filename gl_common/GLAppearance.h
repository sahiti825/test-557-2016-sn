...
public:
	...
	float       _specular_intensity2;
	float       _diffuse_intensity2;
	float       _ambient_intensity2;
	...
	float       _attenuation_coeff2; // the strength of the attenuation
...
public:
    ...
    GLSpotLightSource()
    {
		...
		_cone_angle2 = 10.0;
		_cone_direction2 = glm::vec3(1.0, 0.0, 0.0);
    }
...
public:
     ...
     */
    void setTexture(GLTexture* texture,int num);
