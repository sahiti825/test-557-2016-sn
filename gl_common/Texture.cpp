...
string  GLMultiTexture::_glsl_names[4] = { "texture_background", "texture_foreground","texture_midground", "texture_blend"};
#endif
 ...
 */
int GLTexture::loadAndCreateTexture(string path_and_file,int num)
{
...
bool GLTexture::addVariablesToProgram1(GLuint program, int variable_index, int num)
{
