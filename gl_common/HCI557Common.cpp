...
int animationvariable1;
int animationvariable2;
int animationvariable3;
int animationvariable4;
...
void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
    ...
    else if(key == GLFW_KEY_T && action == GLFW_PRESS) // key t
    {
        g_change_texture_blend++;
        g_change_texture_blend = g_change_texture_blend%3;

    }
	else if (key == GLFW_KEY_G && action == GLFW_PRESS) // key g
	{
		animationvariable1 = 1;

	}
	else if (key == GLFW_KEY_F && action == GLFW_PRESS) // key f
	{
		animationvariable2 = 1;

	}
	else if (key == GLFW_KEY_R && action == GLFW_PRESS) // key r
	{
		animationvariable1 = 0;
		animationvariable3 = 1;

	}
	else if (key == GLFW_KEY_S && action == GLFW_PRESS) // key s
	{
		animationvariable2 = 0;
		animationvariable4 = 1;
