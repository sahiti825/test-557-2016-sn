...
{                                                               
    ...
    vec3 out_specular_color2 = specular_color * specular_coefficient * specular_intensity2;	
	...
	float light_to_surface_angle2 = degrees(acos(dot(ray_direction, cone_direction_norm2))) ;
	...
	vec3 linearColor1 = out_ambient_color  + attenuation * ( out_diffuse_color + out_specular_color); 
    vec3 linearColor2 = out_ambient_color2  + attenuation2 * ( out_diffuse_color + out_specular_color);	
